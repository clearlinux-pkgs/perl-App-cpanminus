...
Source0  : https://cpan.metacpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7048.tar.gz
...
%prep
%setup -q -n App-cpanminus-1.7048
cd %{_builddir}/App-cpanminus-1.7048
pushd ..
cp -a App-cpanminus-1.7048 buildavx2
popd
